...
instruction: (for_loop | if_stat | while_loop | Nazwa | variable | assignment | do_while_loop | function | try_catch_stat | komentarz_poj | komentarz_wiel|return_stat|NL |Nazwa SPACE* INCREMENT)*;
